    ...
    <div className="perspective h-60 w-full my-auto relative">
      ...
      >
        <div className="relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-focus:[transform:rotateY(180deg)] ">
          {/* before flip */}
          <div className="absolute inset-0 bg-gradient-hero w-full h-full text-white rounded-xl p-4 [backface-visibility:hidden] flex flex-col justify-between shadow-[0_10px_25px_-5px_rgba(31,41,55,0.5)]">
          ...
          {/* after flip */}
          <div className="absolute inset-0 bg-gradient-hero w-full h-full text-white rounded-xl p-4 [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col justify-between shadow-[0_10px_25px_-5px_rgba(31,41,55,0.5)]">
